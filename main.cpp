...
int main()
{
	...
	if (ats1 == "t")
	{
		...
		testavimas(file1, ats4, ats3, 1000);

		cout << "10000 duomenu" << endl;
		testavimas(file2, ats4, ats3, 10000);

		cout << "100000 duomenu" << endl;
		testavimas(file3, ats4, ats3, 100000);

		cout << "1000000 duomenu" << endl;
		testavimas(file4, ats4, ats3, 1000000);

		cout << "10000000 duomenu" << endl;
		testavimas(file5, ats4, ats3, 10000000);
	}
	else
	{
		string ats2;
